...
class ItemList extends Component {
    ...
    remove(index){
        //verifica o tamanho para pelo menos ter um campo na lista
        if(!this.props.readOnly && this.props.list.length > 1 ) {
            this.props.arrayRemove('billingCycleForm', this.props.field, index)
        }
    }

    //colocamos os nomes com indice de array para que o Redux form possa mapear e ter nomes unicos para cada linha
    renderRows() {
